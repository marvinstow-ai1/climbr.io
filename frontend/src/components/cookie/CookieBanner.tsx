...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-3 z-40 mx-auto max-w-3xl rounded-xl border border-slate-200 bg-white p-4 shadow-lg sm:p-5"
    >
      ...
      <p className="mt-1 text-sm text-slate2">
        ...
        <Link to="/legal/datenschutz" className="text-primary underline">
