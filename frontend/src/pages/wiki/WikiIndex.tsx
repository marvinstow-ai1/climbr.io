...
export default function WikiIndex() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6" data-testid="wiki-index">
            ...
            <button
              ...
              className={`rounded-full px-3 py-1 text-sm transition ${
                active
                  ...
                  : "border border-slate-200 text-slate2 hover:bg-slate-50"
              }`}
            >
              {c}
            </button>
      ...
      <p className="mt-6 text-sm text-slate2" data-testid="wiki-result-count">
      ...
      {filtered.length === 0 ? (
        <div className="card mt-4 text-center text-slate2">
