    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <p className="text-ink-muted">
          ...
          <Link to="/wiki" className="text-accent underline">
            Zur Wiki-Übersicht
          </Link>
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <header>
        ...
        <p className="mt-1 text-xs text-ink-muted">{article.readingTime} Min. Lesezeit</p>
        <p className="mt-3 text-base text-ink-muted">{article.summary}</p>
      </header>
      ...
      {related.length > 0 && (
        <aside className="mt-10 rounded-xl border border-line bg-white/[0.02] p-5">
